...
})({"R4U7S":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "33c965a5802668a2";
...
},{}],"7sIGJ":[function(require,module,exports) {
var _g9 = require("g9");
const data = {
    x1: 100,
    y1: 100,
...
function render(data, ctx) {
    ...
    const [a, b] = multiply(I, [
        mx2 - mx1,
        my2 - my1
    ]);
    ctx.line(data.x1, data.y1, data.x2, data.y2, {
        stroke: "red"
    });
    ctx.line(data.x3, data.y3, data.x2, data.y2, {
        stroke: "blue"
    });
    ctx.line(mx1, my1, mx1 + 2 * a * dy1, my1 + 2 * a * dx1, {
        stroke: "red"
    });
    ctx.line(mx2, my2, mx2 + 2 * b * dy2, my2 + 2 * b * dx2, {
        stroke: "blue"
    });
    const cx = mx1 + a * dy1;
    const cy = my1 + a * dx1;
...
const demo = _g9(data, render).align("center", "center").insertInto("#circle");
...
},{}]},["R4U7S","7sIGJ"], "7sIGJ", "parcelRequirea4f1")

//# sourceMappingURL=index.802668a2.js.map
