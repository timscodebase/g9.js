...
})({"hJqUX":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "e7d51f9cad02986d";
...
},{}],"jq8JB":[function(require,module,exports) {
var _g9 = require("g9");
const initialData = {
    ax: 0,
    ay: 0,
...
const points = [];
for(let x = 0; x < 2; x++){
    for(let y = 0; y < 2; y++)for(let z = 0; z < 2; z++)points.push([
        x - 0.5,
        y - 0.5,
        z - 0.5
    ]);
...
for(let i = 0; i < points.length; i++){
    ...
    for(let j = i + 1; j < points.length; j++){
        const pj = points[j];
        if (pi.reduce((a, c, k)=>a + (c !== pj[k]), 0) === 1) edges.push([
            pi,
            pj
        ]);
    }
...
_g9(initialData, render, log).align("center", "center").insertInto("#cube");
...
},{}]},["hJqUX","jq8JB"], "jq8JB", "parcelRequirea4f1")

//# sourceMappingURL=index.ad02986d.js.map
