...
})({"9h4S8":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "4bdea30fca86cca1";
...
},{}],"biTSE":[function(require,module,exports) {
var _g9 = require("g9");
const initialData = {
    radius: 100,
    angle: 0
...
function render(data, ctx) {
    ...
    for(var i = 0; i < sides; i++){
        ...
        drawing more exciting! */ ctx.line(r1 * Math.cos(a), r1 * Math.sin(a), r2 * Math.cos(-a), r2 * Math.sin(-a));
    }
}
_g9(initialData, render).align("center", "center").insertInto("#rings");
...
},{}]},["9h4S8","biTSE"], "biTSE", "parcelRequirea4f1")

//# sourceMappingURL=index.ca86cca1.js.map
