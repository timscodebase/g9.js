...
})({"6yFIn":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "434fd9a55b8d73ae";
...
},{}],"96aey":[function(require,module,exports) {
var _g9 = require("g9");
const initialData = {
    l1_start_x: -100,
    l1_start_y: -50,
...
const render = function(data, ctx) {
    ctx.line(data.l1_start_x, data.l1_start_y, data.l1_end_x, data.l1_end_y, {
        "stroke-width": 10
    });
    // if we provide an `affects` option, this
    // line will only change the parameters we name.
    ctx.line(data.l2_start_x, data.l2_start_y, data.l2_end_x, data.l2_end_y, {
        affects: [
            "l2_start_x",
            "l2_start_y"
        ],
    ...
    ctx.line(data.l3_start_x, data.l3_start_y, data.l3_end_x, data.l3_end_y, {
        affects: [
            "l3_start_x",
            "l3_end_y"
        ],
...
_g9(initialData, render).align("center", "center").insertInto("#three-lines");
...
},{}]},["6yFIn","96aey"], "96aey", "parcelRequirea4f1")

//# sourceMappingURL=index.5b8d73ae.js.map
